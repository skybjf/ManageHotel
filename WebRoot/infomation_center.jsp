...
<body>
						...
						<div class="container-fluid">
							...
							<div class="nav-collapse collapse">
								...
								<ul class="nav font-16">
									...
									<li class="active"><a href="infomation_center.jsp"><span
						...
						<div class="span3">
							<div class="well sidebar-nav">
								<ul id="left" class="nav nav-list">
									<li class="nav-header" onclick=getJsonData()><span
										class="icon-envelope icon-vertical"></span> 信息中心</li>
									<li><a>招聘信息</a>
									</li>
									<li><a>酒店新闻</a>
									</li>
	...
	<script type="text/javascript" src="js/infomation_center.js"></script>
	<
</body>
</html>